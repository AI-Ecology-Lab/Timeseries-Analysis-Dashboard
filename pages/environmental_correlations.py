...
if 'Timestamp' in data.columns:
    ...
    with tabs[0]:
        ...
        st.write("This analysis creates a correlation matrix between environmental variables and species.")
        st.write("**When to use:** Use this analysis to understand the relationships between different environmental variables and species.")
        st.write("**How to interpret:** Positive values indicate a positive correlation, while negative values indicate a negative correlation.")
    ...
    with tabs[1]:
        st.header("Environmental Response Curves")
        st.write("This analysis creates response curves for species based on environmental variables.")
        st.write("**When to use:** Use this analysis to visualize how species respond to changes in environmental variables.")
        st.write("**How to interpret:** The trend line shows the general response of the species to the environmental variable.")
    ...
    with tabs[2]:
        ...
        st.write("This analysis performs Principal Component Analysis (PCA) on environmental variables.")
        st.write("**When to use:** Use this analysis to reduce the dimensionality of environmental data and identify key variables.")
        st.write("**How to interpret:** The scree plot shows the explained variance by each principal component. The loadings indicate the contribution of each variable.")
    ...
    with tabs[3]:
        ...
        st.write("This analysis calculates time-lagged correlations between environmental variables and species.")
        st.write("**When to use:** Use this analysis to identify potential time-lagged effects of environmental variables on species.")
        st.write("**How to interpret:** The plot shows the correlation coefficients at different time lags.")
    ...
    with tabs[4]:
        ...
        st.write("This analysis performs threshold analysis on environmental variables and species.")
        st.write("**When to use:** Use this analysis to identify thresholds of environmental variables that affect species abundance.")
        st.write("**How to interpret:** The bar plot shows the mean species count at different thresholds of the environmental variable.")
